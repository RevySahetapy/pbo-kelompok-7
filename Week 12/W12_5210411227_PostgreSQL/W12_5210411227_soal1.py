...
class Pegawai :
    ...
    def insert() :
        try :
            ...
            status = input("Masukan Status\t\t: ")#5210411227_REVY SAHETAPY
        ...
        try :
            for x in cur.fetchall() :#5210411227_REVY SAHETAPY
                if nip in x[0] :
                    ...
                    cur.execute(sql, data)
                    connect.commit()#5210411227_REVY SAHETAPY
                    ...
                    print(f"Jumlah Anak\t: {jmlh_anak}") #5210411227_REVY SAHETAPY
                    print("==============================================\n\n")
                    kembali()
        except :
            print("\nData Tidak Berhasil Di Edit")
    ...
    # DELETE
    def delete(nip):#5210411227_REVY SAHETAPY
        cur.execute("SELECT * FROM pegawai  WHERE nip LIKE %s", [nip])
        try :
            for x in cur.fetchall() :
                if nip in x[0] :
...
class Gaji :
    ...
    def select() :
        try :#5210411227_REVY SAHETAPY
            ...
            for x in cur.fetchall() :
                ...
                print(f"Masuk    : {x[2]}")
                print(f"Sakit    : {x[3]}")
                print(f"Izin     : {x[4]}")#5210411227_REVY SAHETAPY
                print(f"Alfa     : {x[5]}")
                print(f"Lembur   : {x[6]}")
    ...
    def search(nip) :
        try :#5210411227_REVY SAHETAPY
            ...
            for x in cur.fetchall() :
                ...
                print(f"Izin     : {x[4]}")
                print(f"Alfa     : {x[5]}")
                print(f"Lembur   : {x[6]}")#5210411227_REVY SAHETAPY
                print(f"Potongan : {x[7]}\n")  
            print("==============================================\n\n")
            kembali()
        except :#5210411227_REVY SAHETAPY
    ...
    def insert() :
        try :
            ...
            lembur = int(input("Masukan Data Lembur\t: "))#5210411227_REVY SAHETAPY
        ...
        try :#5210411227_REVY SAHETAPY
            for x in cur.fetchall() :
                if nip in x[1] :
                    ...
                    print(f"Izin    : {izin}")
                    print(f"Alfa    : {alfa}")
                    print(f"Lembur  : {lembur}")#5210411227_REVY SAHETAPY
...
while True :
    ...
    if pilihan == '1' :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Jabatan.insert()#5210411227_REVY SAHETAPY
            elif menu == '3' :
                clear_screen()
                Jabatan.search(
                    kd_jabatan = input("Masukan Kode Jabatan : ")
                ...
                clear_screen()
                Jabatan.delete(#5210411227_REVY SAHETAPY
        ...
        try :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Pegawai.insert()#5210411227_REVY SAHETAPY
            elif menu == '3' :
                clear_screen()
                Pegawai.search(
                    nip = input("Masukan NIP : ")
                ...
                clear_screen()
                Pegawai.delete(#5210411227_REVY SAHETAPY
        ...
        try :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Gaji.insert()#5210411227_REVY SAHETAPY
            elif menu == '3' :
                clear_screen()
                Gaji.search(
                    nip = input("Masukan NIP : ")
                ...
                clear_screen()
                Gaji.delete(#5210411227_REVY SAHETAPY
                    nip = input("Masukan NIP yg Ingin Di Hapus : ")
                )
        except :
            clear_screen()
        ...
        try :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Golongan.insert()#5210411227_REVY SAHETAPY
            elif menu == '3' :
                clear_screen()
                Golongan.search(
                    nm_golongan = input("Masukan Nama Golongan : ")
                ...
                clear_screen()
                Golongan.delete(#5210411227_REVY SAHETAPY
