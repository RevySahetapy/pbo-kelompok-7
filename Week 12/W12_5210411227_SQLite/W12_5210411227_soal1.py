...
class Jabatan :
    ...
    def search(kd_jabatan) :
        #try :
            ...
            print(f"\nHasil Pencarian Dari {kd_jabatan}")#5210411203_FEBRIYAN
            print("==============================================")
            for x in cur.fetchall() :
                print(f"Kode Jabatan      : {x[0]}")
                print(f"Nama Jabatan      : {x[1]}")
    ...
    def insert() :
        try :
            ...
            cur.execute(sql,data)#5210411203_FEBRIYAN
            connect.commit()
...
class Golongan :
    ...
    def search(nm_golongan) :
        try :#5210411203_FEBRIYAN
            ...
            for x in cur.fetchall() :
                ...
                print(f"Uang Makan\t: {x[4]}")
                print(f"Uang Lembur\t: {x[5]}")
                print(f"Askes\t\t: {x[6]}")#5210411203_FEBRIYAN
            print("==============================================\n\n")
            kembali()
        except :
            print("\nEror")
    ...
    def insert() :
        try :
            ...
            askes = int(input("Masukan Askes\t\t: "))#5210411203_FEBRIYAN
    ...
    # UPDATE
    def update(nm_golongan):#5210411203_FEBRIYAN
        cur.execute(f"SELECT * FROM golongan  WHERE nama_golongan LIKE ?", [nm_golongan])
        try :
            for x in cur.fetchall() :
                if nm_golongan in x[1] :#5210411203_FEBRIYAN
                    print("\n==============================================")
                    ...
                    print(f"Uang Lembur\t: {uang_lbr}") #5210411203_FEBRIYAN
                    print("==============================================\n\n")
                    kembali()
        except :
            print("\nData Tidak Berhasil Di Edit")
...
while True :
    ...
    if pilihan == '1' :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Jabatan.insert()#5210411203_FEBRIYAN
            elif menu == '3' :
                clear_screen()
                Jabatan.search(
                    kd_jabatan = input("Masukan Kode Jabatan : ")
                ...
                clear_screen()
                Jabatan.delete(#5210411203_FEBRIYAN
        ...
        try :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Pegawai.insert()#5210411203_FEBRIYAN
            elif menu == '3' :
                clear_screen()
                Pegawai.search(
                    nip = input("Masukan NIP : ")
                ...
                clear_screen()
                Pegawai.delete(#5210411203_FEBRIYAN
        ...
        try :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Gaji.insert()#5210411203_FEBRIYAN
            elif menu == '3' :
                clear_screen()
                Gaji.search(
                    nip = input("Masukan NIP : ")
                ...
                clear_screen()
                Gaji.delete(#5210411203_FEBRIYAN
                    nip = input("Masukan NIP yg Ingin Di Hapus : ")
                )
        except :
            clear_screen()
        ...
        try :
            ...
            if menu == '1' :
                ...
                clear_screen()
                Golongan.insert()#5210411203_FEBRIYAN
            elif menu == '3' :
                clear_screen()
                Golongan.search(
                    nm_golongan = input("Masukan Nama Golongan : ")
                ...
                clear_screen()
                Golongan.delete(#5210411203_FEBRIYAN
