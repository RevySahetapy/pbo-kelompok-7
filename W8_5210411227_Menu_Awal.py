...
def menu_awal():
    while(True):    #5210411227_REVY RAVLY SABBATHINO SAHETAPY
        ...
        try:
            ...
            print() #5210411227_REVY RAVLY SABBATHINO SAHETAPY
            ...
            if(a==1):
                ...
                kembali()
                continue#5210411227_REVY RAVLY SABBATHINO SAHETAPY
...
def listSplit():
    ...
    with open("stock.txt","r+") as f:
        ...
        for i in range(len(lines)):
            ind=0#5210411227_REVY RAVLY SABBATHINO SAHETAPY
...
def getDate():
    ...
    return str(now().date())#5210411227_REVY RAVLY SABBATHINO SAHETAPY
...
def pinjamkan_buku():
    success=False#5210411227_REVY RAVLY SABBATHINO SAHETAPY
        ...
        try:
            ...
            try:
                if(int(jumlah_stok[a])>0):
                    ...
                    loop=True
                    count=1#5210411227_REVY RAVLY SABBATHINO SAHETAPY
...
def kembalikan_buku():
    ...
    stat=input()        #5210411227_REVY RAVLY SABBATHINO SAHETAPY
    ...
    if(stat.upper()=="Y"):
        ...
        with open("stock.txt","r+") as f:
            for i in range(8):      #5210411227_REVY RAVLY SABBATHINO SAHETAPY
